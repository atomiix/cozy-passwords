[![Travis build status shield](https://img.shields.io/travis/atomiix/cozy-passwords/master.svg)](https://travis-ci.org/atomiix/cozy-passwords)
[![Github Release version shield](https://img.shields.io/github/tag/atomiix/cozy-passwords.svg)](https://github.com/atomiix/cozy-passwords/releases)
...
```sh
$ git clone https://github.com/atomiix/cozy-passwords.git
$ cd cozy-passwords
$ yarn install
```
...
The lead maintainer for Passwords is [atomiix](https://github.com/atomiix), send him/her a :beers: to say hello!
...
Passwords is developed by atomiix and distributed under the [AGPL v3 license][agpl-3.0].
